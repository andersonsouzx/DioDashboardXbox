...
* **Microsoft Excel**: Para processamento de dados e criação das visualizações.
* **Power Query**: Para tratar os dados.
...
3. Caso os dados não carreguem, vá em **Dados > Atualizar Tudo**.
